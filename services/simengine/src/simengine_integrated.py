...
def run_sumo(conf_filename=None, runlog=None):
    ...
    elif 'controller' in sys_cnf.keys():
        print('Single controller found')
        sys_cnf['controllers'] = {}
        sys_cnf['controllers']['controller1'] = {}
        sys_cnf['controllers']['controller1']['controller_file'] = conf_filename
        multi = False
    ...
    for key in sys_cnf['controllers']:
        ...
        if 'controller_file' in sys_cnf['controllers'][key]:
            ...
            if multi:
                ...
                controllers_dict[key]['sumo_name'] = sys_cnf['controller']['sumo_name']
                controllers_dict[key]['print_status'] = sys_cnf['sumo']['print_status']
                
                controllers_dict[key]['controller'] = PhaseRingController(controller_cnf, system_timer)                
