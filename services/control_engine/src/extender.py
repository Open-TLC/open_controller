...
class Extender:
    ...
    def __init__(
        self, timer, group, dets, grpdets, e3dets, ext_params
    ):  # DBIK200803, add e3dets
    ...
    def update_extension(self):
        ...
        if self.ext_mode == 1:
            ...
            if self.conf_sum > 0:
                ...
                traffic_ratio = (
                    self.vehcount / self.conf_sum
                )  # DBIK20250409 replace vehcount with momentum
    ...
    def update_safety_extension(self):
        ...
        if (safety_ext_time < 10.0) and ShortGap:
            ...
            with open("v2x_file.txt", "a") as f:
                f.writelines(
                    f"Signal X: Safety extension of {safety_ext_time} seconds ended at: {curtime}  \n"
                )
